...
#print "Plotting contact matrix" #Uncomment line 148 and below to plot matrix
...
#If you do default sortorder, you get chr names in order chr1,10,11...19,2,21...
#So let's change it to human-readable =)
...
#Print observed/expected figure
...
print "-------------------RATIOs-----------------"
print "chr itra inter intra/inter"
...
for ind,st,end in zip(sortorder,genome_db.chrmStartsBinCont[sortorder],genome_db.chrmEndsBinCont[sortorder]):
	...
	print genome_db.idx2label[ind],intra,inter,intra/inter