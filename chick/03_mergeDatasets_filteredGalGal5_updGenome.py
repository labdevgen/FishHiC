...
genomeName = "GalGal5filteredChrmLevel"
...
wholeGenomeResolutionsKb = [1000,500,200,100,40,25]
#byChromosomeResolutionsKb = [100,40,25]
...
skip = 0 #how many to skip for single replica datasets
...
def refineDataset(filenames, create=True, delete=True, parseInMemory=True):
    ...
    if create == True:  # if we need to parse the input files (.hdf5 from mapping).
        ...
        TR.printMetadata(saveTo=ensure(statFolder + ".stat"))
