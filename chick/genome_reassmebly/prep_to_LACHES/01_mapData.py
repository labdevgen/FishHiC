...
inFastqDir = "/mnt/storage/home/vsfishman/tmp/Distr/Chick_HiC/LACHESIS_test/"  # for mode="fastq" only
...
threads = 8
tmpDir = "/mnt/storage/home/vsfishman/tmp/HiC_tmp/2/"  # this will contain up to 3X the size of the largest input .sra file (256GB is enough for (Rao, 2014), but 128 is not)
