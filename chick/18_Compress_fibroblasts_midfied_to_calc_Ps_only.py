...
genome_db1 = genome.Genome("/mnt/storage/home/vsfishman/HiC/fasta/GalGal5/GCF_000002315.4_Gallus_gallus-5.0_assembly_structure/Primary_Assembly/galGal5_all_contigs.filtered/",
				readChrms=[],
				chrmFileTemplate="N%s.fa")
genome_db2 = genome_db = genome.Genome("/mnt/storage/home/vsfishman/HiC/fasta/GalGal5/GCF_000002315.4_Gallus_gallus-5.0_assembly_structure/Primary_Assembly/galGal5_all_contigs.filtered/",
				readChrms=[],
				chrmFileTemplate="N%s.fa")
...
out = open("Ps_ratio.txt","w")
out.write("\t".join(map(str,[i*res/1000000. for i in range(0,len(N1))]))+"\n")
out.write("\t".join(map(str,N1/N2))+"\n")
out.write("\t".join(map(str,Err))+"\n")
#print N1/N2
#print Err
raise "Stop"
