...
maped_reads_filepath=base_folder+'mapped_reads_'+base_filename+'_Y.hdf5'

FASTQ_fpath="/mnt/storage/home/vsfishman/tmp/Distr/Sp_full2.fastq"
...
genome_db    = genome.Genome(genome_folder+genome_name, readChrms=['#', 'X','Y'])
