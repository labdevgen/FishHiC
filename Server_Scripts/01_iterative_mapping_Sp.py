...
mapped_reads_Sp = h5dict.h5dict('../../data/serov/mapped_reads_Sp.hdf5')
genome_db    = genome.Genome('../../fasta/mm10', readChrms=['#', 'X'])

mapping.parse_sam(
    sam_basename1='../../data/serov/HiC_Sp_1.bam',
    sam_basename2='../../data/serov/HiC_Sp_2.bam',
    out_dict=mapped_reads_Sp,
    genome_db=genome_db, 
    enzyme_name='HindIII')
