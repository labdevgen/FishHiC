...
raw_heatmap = h5dict.h5dict('../../data/serov/heatmap-res-1M_Sp.hdf5', mode='r') 
...
BD.simpleLoad('../../data/serov/heatmap-res-1M_Sp.hdf5', 'HindIII_GM_1')
...
BD.export('HindIII_GM_1', '../../data/serov/IC-heatmap-res-1M_Sp.hdf5')
